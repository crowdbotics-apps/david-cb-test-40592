"""
Django settings for david_cb_test_40592 project.
...
ROOT_URLCONF = 'david_cb_test_40592.urls'
...
WSGI_APPLICATION = 'david_cb_test_40592.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "david_cb_test_40592 API",
    "DESCRIPTION": "API documentation for david_cb_test_40592 App",
    "VERSION": "v1",
}
